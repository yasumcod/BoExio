    ...
    *,
    ...
    for slug in sorted(category_info):
        ...
        aggregate[slug] = {
            ...
            "expected_product_count": base.get("expected_product_count"),
            "initial_visible_product_count": base.get("initial_visible_product_count"),
            "expected_count_status": base.get("expected_count_status", ""),
            "expected_count_error": base.get("expected_count_error", ""),
            "classified_unique_product_master_count": as_int(
                base.get("classified_unique_product_master_count"),
                0,
            ),
