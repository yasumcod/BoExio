...
- 手動 URL リストから代表商品 URL を 1 件読み込む。
- 対象 URL が `https://www.boconcept.com/ja-jp/shop/` 配下であることを確認する。
...
- `canonical_price` は Phase 1 では原則として `display_price` と同じ値、または空欄とする。
